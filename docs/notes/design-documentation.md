...
在这篇文章中，我们将深入探讨如何撰写一份全面的设计文档，其中包含了详细的介绍和实用的技巧。

<img src="/posts/design-documentation/0001.png"/>

## 概要

通过概要，读者能够以最快的速度深入了解设计文档的核心内容。一份卓越的概要可以迅速让所有人达成共识，明确方向。在设计文档中，概要的主题通常是介绍当前需要解决的问题，并阐述其为何值得被关注和解决。

<!-- **介绍正在解决的问题，并说明为什么它值得被解决**

* 明确指出当前正在处理的问题是什么。需要对问题进行清晰而简洁的描述，使读者能够理解问题的本质和范围。

* 解释为什么这个问题需要被解决。需要提及该问题的重要性、影响范围、潜在的好处或可能带来的改善。 -->


## 现状与背景

* **描述正在修改的结构并定义专有名词，解释那些名字不显眼的系统是干什么的**
  * 详细阐述正在进行修改的结构。包括修改内容、目的以及对整体结构的影响。
  * 解释那些名字不显眼或鲜为人知的系统的功能或作用，以便更好地理解整个结构的运作。
* **谈谈目前解决响应问题的方法**
  * 深入讨论和交流目前解决响应问题的各种方法。
* **是否正在采用的变通方式**
  * 说明当前是否正在使用某种变通方式来解决问题或应对情况。
* **它们的缺点是什么**
  * 分析上文中的响应方案、变通方式等的不足之处。
...
我们需要分析这个问题，以确定它为什么值得我们去解决。我们可能需要考虑这个问题的重要性、影响范围、潜在的好处，以及可能带来的改善等方面。通过回答这个问题，我们可以更好地理解解决这个问题的意义和动机。

完成这项工作后，我们将获得哪些好处？我们需要把这些好处与业务需求联系起来。这意味着我们要解释为什么这些好处对业务目标的实现至关重要，以及它们如何与业务战略、客户需求或其他相关因素相契合。
...
记录下你初步暂定的第一想法，但还没有最终确定。这个想法可能是在当前情况下最合适的，但需要进一步考虑和评估。

找到一个解决方案并不意味着停止思考。我们还需要考虑其他可能的解决方案或思路。通过思考其他的想法，我们可以拓展思维，发现更多的选择和可能性。

对不同想法进行比较和权衡。我们需要评估每个想法的优点和缺点，考虑它们在不同方面的影响和效果。

确定并说明其他可行的替代方案。这些替代方案应该是经过认真考虑和分析的，具有一定的合理性和可行性。确定的同时解释为什么拒绝其他替代方案。需要说明为什么这些替代方案不适合当前的情况或不能满足特定的需求。
